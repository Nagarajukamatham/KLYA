...
- (void)setupXIB {
    ...
    self.inputView = [[[NSBundle bundleForClass:[self class]]loadNibNamed:@"DAInputView" owner:self options:nil]objectAtIndex:0];
    ...
    switch (selectedMatixIndex) {
        case 91:
        {
            ...
            if (isPinEnabled) {
                ...
                self.dotImg1.image = [UIImage imageNamed:@"dot_white_HD"];
            }
            selectedMatixIndex = 92;
        ...
        case 92:
        {
            ...
            if (isPinEnabled) {
                ...
                self.dotImg2.image = [UIImage imageNamed:@"dot_white_HD"];
            }
            selectedMatixIndex = 93;
        }
            break;
        case 93:
        {
            ...
            if (isPinEnabled) {
                ...
                self.dotImg3.image = [UIImage imageNamed:@"dot_white_HD"];
            }
            selectedMatixIndex = 94;
        ...
        case 94:
        {
            ...
            if (isPinEnabled) {
                ...
                self.dotImg4.image = [UIImage imageNamed:@"dot_white_HD"];
            }
